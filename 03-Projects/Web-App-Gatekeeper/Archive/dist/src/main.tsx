...
import './theme.css';
import { migrateV2, getAll, put, uid, type Keyword, type Criterion, type WishItem, type AuditRec, type CachedSearch } from './services/store';
...
function App() {
  return (
    <>
      <header id="hdr"><h1>Gatekeeper</h1><span>Connoisseur Field Kit · v3.0</span></header>
      <main>
