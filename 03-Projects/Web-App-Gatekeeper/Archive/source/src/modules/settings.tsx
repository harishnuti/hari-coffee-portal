...
import { toast, keywords, criteria, wishlist, audits, theme, setTheme, type ThemeChoice } from '../state';
...
export function Settings() {
  ...
  return (
    <div class="pane">
      ...
      <p class="mono-note">
        GATEKEEPER v3.0.0 · CONNOISSEUR FIELD KIT<br />
        MASTER ARCHIVE: 53 ENTRIES · 29 CAFÉS · 17 STARRED<br />
        DATA SOURCE: hari_coffee_audit_unified_2026_06Jul2026<br />
