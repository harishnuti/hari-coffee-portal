...
import { audits, toast, auditPrefill } from '../state';
...
const cafeOptions = [...new Set(MASTER.map(e => e.Cafe_Name))].sort();
...
export function Audit() {
  return (
    <div class="pane">
      ...
      <div class="sec-lbl">Three-Phase Read</div>
      <div class="phase hot"><b>Hot — Volatiles First</b>
      ...
      <div class="phase mid"><b>Mid-Cool — Sugars Emerge</b>
      ...
      <div class="phase cool"><b>Cool — The Truth</b>
      ...
      <button class="btn" onClick={save}>Save to Device</button>
